...
public class JsonCasingPolicy : JsonNamingPolicy
{
    private readonly Casing _casing;

    private JsonCasingPolicy(Casing casing) => _casing = casing;

    public static JsonCasingPolicy Default(Casing casing) => new(casing);
